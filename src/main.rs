...
pub fn get_private_key(seed: [u8; 64], hd_path: &StandardHDPath) -> ExtendedPrivKey {
    ...
    let private_key = master.derive_priv(&secp, &DerivationPath::from(hd_path)).unwrap();
    return private_key;
}
...
fn test_get_private_key(){
    ...
    assert_eq!(private_key.private_key.to_string(),"L3sQh1LbgjxxsGW9hgSskg87MaMJWGcp4Pf8acAjbbeFSNBrPVC4")
}
...
fn test_get_public_key(){
    ...
    assert_eq!("032352a1c4465934cdff949e4f0bb9a050676a9f6162ecca238612b08519bdcded",public_key.public_key.to_string());
